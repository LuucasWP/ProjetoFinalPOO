...
namespace ProjetoFinalPOO.Model.Telas
{
    ...
    public class TelaCreditos : ITela
    {
        ...
        private void DesenharMecanicasCombate()
        {
            ...
            RenderizadorUI.DesenharLinhaConteudo("  - Embate (Clash): Confronto direto onde moedas (Cara/Coroa) influenciadas pela Sanidade decidem o vencedor.", RenderizadorUI.LarguraPadrao, ConsoleColor.Gray, ConsoleColor.DarkCyan);
